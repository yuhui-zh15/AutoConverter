...
class ReasoningAgent(Agent):
    ...
    def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        reasoning_prompt = get_prompt("reasoning_generation_system_prompt")
        reasoning_user_prompt = get_prompt(
        ...
        reply = self._get_reply(
            input_data["image_path"], reasoning_prompt, reasoning_user_prompt, Gen
        )
